...
paddle_ocr = PaddleOCR(
    ...
    show_log=False,
    max_batch_size=1,  # reduced batch size to avoid memory issues
    use_dilation=False,  # disabled to reduce memory usage
    det_db_score_mode='fast',  # faster mode to avoid issues
...
def check_ocr_box(image_source: Union[str, Image.Image], display_img = True, output_bb_format='xywh', goal_filtering=None, easyocr_args=None, use_paddleocr=False):
    ...
    if use_paddleocr:
        try:
            ...
            if result and result[0]:  # Check if result exists and is not None
