...
def process(
    ...
    try:
        ...
        if image_base64_input.startswith('data:image'):
            image_base64_input = image_base64_input.split(',')[1]
        
        image_bytes = base64.b64decode(image_base64_input)
    ...
    t2=time.time()
    print(f'finish processing. time taken: f{t2-t1}')
...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        with gr.Column():
            image_input_component = gr.Textbox(
                label='Upload base64 image', 
        ...
        with gr.Column():
            image_output_component = gr.Textbox(label='Image base64', placeholder='Text Output')
